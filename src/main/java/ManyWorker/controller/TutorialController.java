...
public class TutorialController {
	...
	// Listar todos los tutoriales de un Trabajador específico por su ID
	@GetMapping("/trabajador/{trabajadorId}")
	public List<Tutorial> listarTutorialesPorTrabajador(@PathVariable int trabajadorId) {
		return tutorialService.listarTutorialesPorIdTrabajador(trabajadorId);
	}
	...
	@PutMapping("/{id}")
	public ResponseEntity<Tutorial> editarTutorial(@PathVariable int id, @RequestBody Tutorial nuevosDatos) {
		try {
